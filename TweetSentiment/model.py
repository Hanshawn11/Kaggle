...
#-----------hyper params-----------------------------
MAX_LEN = 96
#MODEL = TFRobertaModel.from_pretrained('roberta-base',output_hidden_states=True) # outputs all hidden states
...
EPOCHS = 4   #change maybe
BATCH_SIZE = 32 
PAD_ID = 1
SEED = 99999  #important
LABEL_SMOOTHING = 0.2
...
#-------------cross--validation--------------------------------
jac = []; VER='25'; DISPLAY=1 # USE display=1 FOR INTERACTIVE
